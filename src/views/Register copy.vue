  ...
  <div class="relative bg-gray-100 py-16 sm:py-6 lg:py-14">
    ...
    >
      <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
        <TabGroup @change="changedTab" vertical>
          <aside class="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
            <TabList v-for="item in navigation" :key="item.name">
...
const navigation = [
  { name: "Registration", href: "#", icon: UserCircleIcon, current: true },
  {
    name: "Stateroom",
    href: "#",
    icon: KeyIcon,
  ...
  { name: "Guest Info", href: "#", icon: CreditCardIcon, current: false },
  { name: "Sponsorship", href: "#", icon: UserGroupIcon, current: false },
  { name: "Payments", href: "#", icon: ViewGridAddIcon, current: false },
];
